...
BackendService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.4.0", ngImport: i0, type: BackendService, deps: [{ token: i1.ApiService }], target: i0.ɵɵFactoryTarget.Injectable });
