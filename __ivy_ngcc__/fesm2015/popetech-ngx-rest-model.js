...
ApiService.ɵfac = function ApiService_Factory(t) { return new (t || ApiService)(ɵngcc0.ɵɵinject(ɵngcc1.HttpClient), ɵngcc0.ɵɵinject(CONFIG)); };
ApiService.ɵprov = /*@__PURE__*/ ɵngcc0.ɵɵdefineInjectable({ token: ApiService, factory: ApiService.ɵfac });
...
BackendService.ɵfac = function BackendService_Factory(t) { return new (t || BackendService)(ɵngcc0.ɵɵinject(ApiService)); };
BackendService.ɵprov = /*@__PURE__*/ ɵngcc0.ɵɵdefineInjectable({ token: BackendService, factory: BackendService.ɵfac });
BackendService.ctorParameters = () => [
    { type: ApiService }
];
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(BackendService, [{
        type: Injectable
...
NgxRestModelModule.ɵmod = /*@__PURE__*/ ɵngcc0.ɵɵdefineNgModule({ type: NgxRestModelModule });
NgxRestModelModule.ɵinj = /*@__PURE__*/ ɵngcc0.ɵɵdefineInjector({ providers: [
        ApiService,
        BackendService
    ], imports: [[]] });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(NgxRestModelModule, [{
        type: NgModule,
        args: [{
                imports: [],
                declarations: [],
